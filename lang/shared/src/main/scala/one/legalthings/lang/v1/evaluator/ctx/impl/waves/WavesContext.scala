package one.legalthings.lang.v1.evaluator.ctx.impl.waves

import cats.data.EitherT
import one.legalthings.lang.v1.compiler.Terms._
import one.legalthings.lang.v1.compiler.Types.{BYTEVECTOR, LONG, STRING, _}
import one.legalthings.lang.v1.evaluator.FunctionIds._
import one.legalthings.lang.v1.evaluator.ctx._
import one.legalthings.lang.v1.evaluator.ctx.impl.{EnvironmentFunctions, PureContext}
import one.legalthings.lang.v1.evaluator.ctx.impl.PureContext.fromOption
import one.legalthings.lang.v1.traits._
import one.legalthings.lang.v1.{CTX, FunctionHeader}
...
object WavesContext {
  ...
  def build(env: Environment): CTX = {
    ...
    val txByIdF: BaseFunction = {
      val returnType = one.legalthings.lang.v1.compiler.Types.UNION.create(one.legalthings.lang.v1.compiler.Types.UNIT +: anyTransactionType.l)
    ...
    val vars: Map[String, (FINAL, LazyVal)] = Map(
      ("height", (one.legalthings.lang.v1.compiler.Types.LONG, LazyVal(EitherT(heightCoeval)))),
