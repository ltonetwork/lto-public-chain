...
import cats.Monoid
import one.legalthings.lang.v1.FunctionHeader
import one.legalthings.lang.v1.compiler.CompilerContext._
import one.legalthings.lang.v1.compiler.Types.{CASETYPEREF, FINAL}
import one.legalthings.lang.v1.evaluator.ctx.{BaseFunction, CaseType, DefinedType, FunctionTypeSignature}
import shapeless._
