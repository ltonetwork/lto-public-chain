...
import one.legalthings.lang.v1.compiler.CompilerContext
import one.legalthings.lang.v1.compiler.Types.{BOOLEAN, BYTEVECTOR, STRING}
import one.legalthings.lang.v1.evaluator.FunctionIds._
import one.legalthings.lang.v1.evaluator.ctx.{BaseFunction, EvaluationContext, NativeFunction}
import one.legalthings.lang.v1.{BaseGlobal, CTX}
