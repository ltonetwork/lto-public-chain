package one.legalthings.features

import one.legalthings.features.BlockchainFeatureStatus.{Activated, Approved, Undefined}
import one.legalthings.features.api.NodeFeatureStatus.{Implemented, NotImplemented, Voted}
