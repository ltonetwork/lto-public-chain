...
import one.legalthings.serialization.{BytesSerializable, Deser, JsonSerializable}
import one.legalthings.transaction.ValidationError.{GenericError, InvalidSignature}
