package one.legalthings.transaction.assets

import com.google.common.primitives.Bytes
import one.legalthings.crypto
import one.legalthings.state.ByteStr
import monix.eval.Coeval
import one.legalthings.account.{AddressScheme, PrivateKeyAccount, PublicKeyAccount}
import one.legalthings.serialization.Deser
import one.legalthings.transaction.ValidationError.{GenericError, UnsupportedVersion}
import one.legalthings.transaction._
import one.legalthings.transaction.smart.script.{Script, ScriptReader}
