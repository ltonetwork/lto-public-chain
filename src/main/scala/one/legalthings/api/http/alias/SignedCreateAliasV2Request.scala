package one.legalthings.api.http.alias

import io.swagger.annotations.ApiModelProperty
import play.api.libs.json.{Format, Json}
import one.legalthings.account.{Alias, PublicKeyAccount}
import one.legalthings.api.http.BroadcastRequest
import one.legalthings.transaction.{CreateAliasTransaction, CreateAliasTransactionV2, Proofs, ValidationError}
