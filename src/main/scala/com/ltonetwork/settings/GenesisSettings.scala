...
object GenesisSettings {
  val MAINNET: GenesisSettings = GenesisSettings(
    1547303338475L,
    1547303338475L,
    Constants.UnitsInLTO * Constants.TotalLTOMainnet,
  ...
  val TESTNET: GenesisSettings = GenesisSettings(
    1534497076380L,
    1534497076380L,
    Constants.UnitsInLTO * Constants.TotalLTOTestnet,
    ByteStr.decodeBase58("47pP5r1Kh159XmxcfG2eQVj6dKNhub3mvGgpJovcw7EcZyJswFLYyKGYNV21BGJ8pwkajA75ZLMWFBdv3BzMRMk").toOption,
    List(
      GenesisTransactionSettings("3N6mZMgGqYn9EVAR2Vbf637iej4fFipECq8", (Constants.UnitsInLTO * Constants.TotalLTOTestnet * 0.01).toLong),
      GenesisTransactionSettings("3N51gbw5W3xvSkcAXtLnXc3SQh2m9e6TBcy", (Constants.UnitsInLTO * Constants.TotalLTOTestnet * 0.01).toLong),
      GenesisTransactionSettings("3NAxYD4nFbYqHo8gz9Hsfj13s283xNYvGNi", (Constants.UnitsInLTO * Constants.TotalLTOTestnet * 0.9).toLong),
      GenesisTransactionSettings("3Mv7ajrPLKewkBNqfxwRZoRwW6fziehp7dQ", (Constants.UnitsInLTO * Constants.TotalLTOTestnet * 0.01).toLong),
      GenesisTransactionSettings("3NARPnCPG4egZbFUQENZ6VDojQqMCpGEG9i", Constants.UnitsInLTO * (Constants.TotalLTOTestnet * 0.07).round),
    ),
    100,
    60.seconds
  )
