...
import com.wavesplatform.state.{AddressId, AssetDistribution, AssetDistributionPage, Height, TransactionId, TxNum, _}
...
import com.wavesplatform.transaction.{CreateAliasTransaction, _}
