package one.legalthings.state.diffs.smart
...
import one.legalthings.transaction.{DataTransaction, Transaction}
import one.legalthings.transaction.smart.BlockchainContext
import one.legalthings.transaction.transfer.TransferTransaction
