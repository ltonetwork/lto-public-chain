...
import one.legalthings.state.{BinaryDataEntry, BooleanDataEntry, ByteStr, DataEntry, EitherExt2, IntegerDataEntry}
...
import one.legalthings.lagonaki.mocks.TestBlock.{create => block}
import one.legalthings.transaction.{DataTransaction, GenesisTransaction}
