...
object TestFunctionalitySettings {
  val Enabled = FunctionalitySettings(
    ...
    preActivatedFeatures = Map(BlockchainFeatures.SmartAccounts.id -> 0, BlockchainFeatures.SmartAssets.id -> 0, BlockchainFeatures.FairPoS.id -> 0, BlockchainFeatures.AssociationTransaction.id -> 0),
