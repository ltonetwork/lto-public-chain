package one.legalthings.it.async.activation

import com.typesafe.config.Config
import one.legalthings.features.BlockchainFeatureStatus
import one.legalthings.features.api.{FeatureActivationStatus, NodeFeatureStatus}
import one.legalthings.it.api.AsyncHttpApi._
import one.legalthings.it.api.BlockHeaders
