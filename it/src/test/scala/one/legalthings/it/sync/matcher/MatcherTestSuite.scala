package one.legalthings.it.sync.matcher

import com.typesafe.config.{Config, ConfigFactory}
import one.legalthings.it.api.SyncHttpApi._
import one.legalthings.it.api.SyncMatcherHttpApi._
import one.legalthings.it.transactions.NodesFromDocker
import one.legalthings.it.api.LevelResponse
import one.legalthings.it.sync.matcher.MatcherMassOrdersTestSuite.orderLimit
import one.legalthings.it.ReportingTestName
import one.legalthings.state.ByteStr
import one.legalthings.it.util._

import scala.concurrent.duration._
import org.scalatest.{BeforeAndAfterAll, CancelAfterFailure, FreeSpec, Matchers}
import one.legalthings.transaction.assets.exchange.{AssetPair, Order, OrderType}
...
object MatcherTestSuite {
  ...
  import one.legalthings.it.NodeConfigs._
