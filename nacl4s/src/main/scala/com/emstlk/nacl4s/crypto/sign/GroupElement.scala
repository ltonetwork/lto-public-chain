...
class Precomp(val yplusx: Array[Int] = new Array[Int](10), val yminusx: Array[Int] = new Array[Int](10), val xy2d: Array[Int] = new Array[Int](10))
...
class P2(val x: Array[Int] = new Array[Int](10), val y: Array[Int] = new Array[Int](10), val z: Array[Int] = new Array[Int](10))
